...
cd ..
colcon build --packages-select lunar_local_planning
ros2 launch lunar_local_planning local_path_planning.py use_moon:=True use_o2_rover:=True
ros2 run lunar_local_planning fake_path --ros-args -p use_moon:=True
```
