...
def generate_launch_description():
    ...
    roverUrdfPath = os.path.join(FindPackageShare('lunar_local_planning').find('lunar_local_planning'), 'urdf', 'rover', 'model.sdf')
    o2roverUrdfPath = os.path.join(FindPackageShare('lunar_local_planning').find('lunar_local_planning'), 'urdf', 'o2_rover', 'model.sdf')
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('world_file', default_value=LaunchConfiguration('world_file', default=os.path.join(FindPackageShare('lunar_local_planning').find('lunar_local_planning'), 'worlds', 'moon.world')),
        ...
        GroupAction([
            ...
            SetEnvironmentVariable("GZ_SIM_RESOURCE_PATH",value = os.path.join(get_package_prefix('lunar_local_planning'), 'share')),
        ...
        Node(
            ...
            output='screen',
            parameters=[
                {"config_file": os.path.join(FindPackageShare('lunar_local_planning').find('lunar_local_planning'), 'config', 'gazebo_bridge.yaml')}
            ]
        ),
