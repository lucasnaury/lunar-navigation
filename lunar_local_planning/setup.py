...
package_name = 'lunar_local_planning'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'my_robot_driver = lunar_local_planning.my_robot_driver:main',
            'obstacle_avoider = lunar_local_planning.obstacle_avoider:main',
            'fake_path = lunar_local_planning.fake_path_publisher:main',
            'plotter = lunar_local_planning.trajectory_plotting:main'
        ],
    },
)
